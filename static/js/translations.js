...
const translations = {
  ru: {
    ...
    "appetizers": "Закуски",
    "salads": "Салаты",
    "seafood_and_fish": "Морепродукты и Рыба",
    "pasta": "Паста",
    "meat_dishes": "Мясные блюда",
    "burgers_and_more": "Бургеры и другое",
    "desserts": "Десерты",

    // Категории Напитков
    "coffee_and_tea": "Кофе и Чай",
    "juices_and_water": "Соки и Вода",
    "beer_and_snacks": "Пиво и закуски",
    "non_alcoholic_cocktails": "Безалкогольные коктейли",
    "alcoholic_cocktails": "Алкогольные коктейли",
    "whisky": "Виски",
    "cognac": "Коньяк",
    "sparkling_wines": "Игристые",
    "white_wines": "Белые вина",
    "red_wines": "Красные вина",
    "rose_wines": "Розовые вина",
  ...
  ro: {
    ...
    "food_btn": "Mâncare",
    "drinks_btn": "Băuturi",
    "empty_menu": "Nu există preparate disponibile în această categorie",
    "add_to_cart": "Adaugă în coș",
    "loading_menu": "Se încarcă meniul...",
    ...
    "item_added": "a fost adăugat în coș",
    "item_removed": "Produs eliminat din coș",
    "order_placed": "Comanda dvs. a fost acceptată! Veți fi contactat de operator.",
    
    // Форма заказа
    "checkout_title": "Finalizare comandă",
    "name_placeholder": "Numele dvs.",
    "phone_placeholder": "Telefon de contact",
    "address_placeholder": "Adresă de livrare",
  ...
  en: {
    ...
    "order_placed": "Your order has been placed! An operator will contact you.",
